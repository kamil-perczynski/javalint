...
public class WriteableCoreLocalVirtualFile extends VirtualFile {
    ...
    public @Nullable BasicFileAttributes getAttributes(boolean full) {
        return delegate.getAttributes(full);
    }
    ...
    public VirtualFile copy(Object requestor, VirtualFile newParent, @NonNls String copyName) throws IOException {
    ...
    @Override
    public <T> T computeWithPreloadedContentHint(byte[] preloadedContentHint, Supplier<? extends T> computable) {
